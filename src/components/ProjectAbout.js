const ProjectAbout = ({ isAboutDisplayed, setIsAboutDisplayed }) => {
  ...
  return (
    <>
      ...
      <h1>About the Amazon Park Community Experience Project</h1>
      <p>
        Soy milk creamy cauliflower alfredo cumin artichoke hearts strawberry
        mango smoothie creamiest raspberries cayenne black bean chili dip almond
        milk chai latte chili pepper cool grains sweet potato basil picnic salad
        jalapeño. Seitan cashew pinch of yum entree candy cane winter
        overflowing berries apple vinaigrette four-layer lemon lime minty
        grenadillo frosted gingerbread bites seeds chickpea crust pizza udon
        noodles mint lime taco salsa salad pumpkin roasted brussel sprouts Thai
        super chili. Naga viper bruschetta veggie burgers morning smoothie bowl
        apples spiced pumpkin chili Italian pepperoncini green onions black bean
        wraps dark and stormy samosa tasty basmati blackberries walnut mushroom
        tart bite sized hummus falafel bowl red pepper açai lemonade zest lemon
        hummus pineapple salsa cool off sesame soba noodles cozy butternut.
      </p>
      <p>
